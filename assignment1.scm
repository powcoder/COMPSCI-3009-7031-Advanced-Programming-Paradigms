...
(define (my-sum-multiples start my-sum n)
	(cond
		((start >= n) my-sum)
		((= 0 (modulo start 3)) (my-sum-multiples (+ start 1) (+ start my-sum) n ))
		((= 0 (modulo start 5)) (my-sum-multiples (+ start 1) (+ start my-sum) n ))
		(else (my-sum-multiples (+ start 1) my-sum n))))

(define (sum-of-multiples n)
  ; 0 ; write this function, feel free to add additional helper functions
  (my-sum-multiples 0 0 n)
)
